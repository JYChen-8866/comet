...
/// Shared reduced-motion flag (plain gpui has no app-level switch at this rev).
...
pub fn set_reduced_motion(_cx: &mut App, reduced: bool) {
    REDUCED_MOTION.store(reduced, std::sync::atomic::Ordering::Relaxed);
}

/// Read the global reduced-motion flag.
pub fn reduced_motion(_cx: &App) -> bool {
