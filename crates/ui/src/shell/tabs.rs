...
pub(super) fn reorder_tabs<T>(tabs: &mut Vec<T>, from: usize, to: usize) {
...
pub(super) fn drop_index(rel_x: f32, tab_w: f32, count: usize) -> usize {
...
pub(super) fn slide_offset(ix: usize, from: usize, over: usize) -> f32 {
