...
mod tests {
    ...
    #[test]
    fn free_combos_record_without_conflict() {
        // With only the sidebar toggle bound, every other combo is free.
        ...
        // A shortcut's own combo is not a conflict either.
        assert_eq!(
            conflict_owner(&keymap, ShortcutId::ToggleSidebar, "mod-s"),
            None
        );
    }
}
