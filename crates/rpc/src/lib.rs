//! comet-rpc — the typed control plane over WebSocket + in-memory transports.
//!
...
pub mod methods {
    ...
    /// Plain local folder listing for the add-space browser.
    pub const LIST_FOLDERS: &str = "ListFolders";
    /// Legacy ref/worktree surface kept wire-compatible; the local build does
    /// not implement git operations.
    pub const LIST_REFS: &str = "ListRefs";
    pub const SWITCH_REF: &str = "SwitchRef";
    pub const CREATE_WORKTREE: &str = "CreateWorktree";
    // Uploads / attachments (local files staged for the note agent).
